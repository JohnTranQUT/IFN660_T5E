...
public:
	ReferenceType(LanguageType *_Base, LanguageType *_Referenced, bool _StrictReference, ObjectType *_thisValue = nullptr) : Base(_Base), Referenced(_Referenced), StrictReference(_StrictReference), thisValue(_thisValue) { };
